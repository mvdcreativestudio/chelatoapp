...
<div class="app-ecommerce" data-products='@json($products)' data-budget-items='@json($budget->items)' data-allow-no-stock='{{ $companySettings->allow_BudgetsWhitoutStock ? "true" : "false" }}'>
