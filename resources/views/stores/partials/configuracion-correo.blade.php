  ...
  <div class="card">
      ...
      <div class="card-body text-center d-flex flex-column justify-content-between">
          <div>
              ...
              <small class="d-block mb-3">Gestiona la configuración de correo de tu tienda. <br> Modifica la información solo si deseas utilizar un correo personalizado para las comunicaciones desde la plataforma. No lo modifiques si no estás seguro.</small>
          </div>
