...
<div class="app-ecommerce">
  ...
  @endif <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="supplier-phone" name="phone" placeholder="Teléfono del proveedor" value="{{ $supplier->phone }}">
            </div>

            <div class="mb-3">
              <label class="form-label" for="supplier-address">Dirección</label>
              <input type="text" class="form-control" id="supplier-address" name="address" placeholder="Dirección del proveedor" value="{{ $supplier->address }}">
            </div>

            <div class="mb-3">
              <label class="form-label" for="supplier-city">Ciudad/Barrio</label>
              <input type="text" class="form-control" id="supplier-city" name="city" placeholder="Ciudad del proveedor" value="{{ $supplier->city }}">
            </div>

            <div class="mb-3">
              <label class="form-label mb-0" for="supplier-state">Departamento</label>
              <input type="text" class="form-control" id="supplier-state" name="state" placeholder="Departamento del proveedor" value="{{ $supplier->state }}">
            </div>

            <div class="mb-3">
              <label class="form-label" for="supplier-country">País</label>
              <input type="text" class="form-control" id="supplier-country" name="country" placeholder="País del proveedor" value="{{ $supplier->country }}">
            </div>

            <div class="mb-3">
              <label class="form-label" for="supplier-email">Email</label>
              <input type="email" class="form-control" id="supplier-email" name="email" placeholder="Email del proveedor" value="{{ $supplier->email }}">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="supplier-doc_number" name="doc_number" placeholder="Número de documento del proveedor" value="{{ $supplier->doc_number }}">
            </div>
