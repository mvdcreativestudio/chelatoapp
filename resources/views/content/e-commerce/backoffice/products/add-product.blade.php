...
@section('page-script')
@vite([
  'resources/assets/js/app-ecommerce-product-add.js', 'resources/assets/js/app-ecommerce-product-add-features.js', 'resources/assets/js/app-ecommerce-product-add-gallery.js',
])
@endsection
