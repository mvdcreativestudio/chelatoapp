      ...
      <div class="modal-body">
        <form id="editCouponForm">
          ...
          <div class="mb-3 form-check">
            ...
            <input type="checkbox" class="form-check-input" id="editSingleUse" name="single_use" value="1">
            <label class="form-check-label" for="editSingleUse">Este cupón es de uso único por cliente</label>
          </div>
          <div class="mb-3">
