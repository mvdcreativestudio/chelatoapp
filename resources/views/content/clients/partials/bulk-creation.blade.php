    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="importForm" action="{{ route('clients.import') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <a href="{{ route('clients.download-template') }}" class="text-muted text-sm" id="download-template">Haz click aquí para descargar la plantilla</a>
          </div>
        ...
        $('#importForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    location.reload(); // Actualizar la lista de clientes
                },
                error: function(xhr) {
                    ...
                    if (errors && errors.errors) {
                        ...
                        toastr.error('Error al importar clientes');
                    }
                }
            });
        });
