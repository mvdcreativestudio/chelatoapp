...
class Order extends Model
{
    ...
    protected $fillable = ['date', 'time', 'origin', 'client_id',
      ...
      'payment_method', 'shipping_method', 'estimate_id', 'shipping_id', 'delivery_offer_id', 'uuid', 'is_billed', 'doc_type', 'document', 'cash_register_log_id', 'mp_merchant_order_id', 'preference_id'];
